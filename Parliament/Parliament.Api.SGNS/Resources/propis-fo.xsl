                ...
                <fo:flow flow-name="xsl-region-body">
                    ...
                    <fo:block font-family="Arial" font-size="10px" width="70%" margin-left="10%" margin-right="10%">
                            ...
                            <xsl:when test="//parliament:Deo">
                                <xsl:for-each select="//parliament:Deo">
                                    ...
                                    <xsl:for-each select="//parliament:Glava">
                                        ...
                                        <fo:block font-family="Arial" text-align="center" font-size="19" margin="20px">Glava 
                                        ...
                                        <xsl:for-each select="//parliament:Odeljak">
                                            ...
                                            <fo:block font-family="Arial" text-align="center" font-size="19" margin="20px"> Odeljak 
                                            ...
                                            <xsl:choose>
                                                <xsl:when test="//parliament:Pododeljak">
                                                    ...
                                                    <fo:block font-family="Arial" text-align="center" font-size="19" margin="20px"> Pododeljak 
                                                        <xsl:value-of select="//@parliament:RedniBroj"/>
                                                    </fo:block>
                                                    <xsl:for-each select="//parliament:Clan">
                                                        ...
                                                        <fo:block font-family="Arial" text-align="center" font-size="19" margin="20px"> Član 
                                                            <xsl:value-of select="//@parliament:RedniBroj"/>
                                                        </fo:block>
                                                        <xsl:choose>
                        ...
                        <xsl:for-each select="//parliament:Prilog">
                            <fo:block id="{@Id}" font-family="Arial" text-align="center" font-size="19" margin="20px"> Naziv Priloga: 
                                <xsl:value-of select="current()"/>
                            </fo:block>
                        </xsl:for-each>
